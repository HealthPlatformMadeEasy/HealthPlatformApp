...
public partial class Metabolite
{
    ...
    [Column("hmdb_id")]
    [StringLength(25)]
    public string HmdbId { get; set; } = null!;
    ...
    [Column("export_to_hmdb")]
    public bool ExportToHmdb { get; set; }
    ...
    [Column("moldb_formal_charge")]
    public int? MoldbFormalCharge { get; set; }
    ...
    [Column("hml_compound")]
    public bool HmlCompound { get; set; }

    [Column("predicted_in_hmdb")]
    public bool? PredictedInHmdb { get; set; }
