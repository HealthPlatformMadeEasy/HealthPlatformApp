...
public partial class Compound
{
    ...
    [Column("phenolexplorer_id")]
    public int? PhenolexplorerId { get; set; }
    ...
    public virtual ICollection<CompoundAlternateParent> CompoundAlternateParents { get; set; } = new List<CompoundAlternateParent>();

    [InverseProperty("Compound")]
    public virtual ICollection<CompoundExternalDescriptor> CompoundExternalDescriptors { get; set; } = new List<CompoundExternalDescriptor>();

    [InverseProperty("Compound")]
    public virtual ICollection<CompoundSubstituent> CompoundSubstituents { get; set; } = new List<CompoundSubstituent>();
