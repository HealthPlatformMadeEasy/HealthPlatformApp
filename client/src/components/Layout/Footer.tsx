      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 flex space-x-5 sm:mt-0 sm:justify-center">
            <a
              href="#"
              className="flex transform items-center justify-center rounded-full border-2 bg-white text-2xl text-blue-600
              duration-500 hover:-translate-y-1 hover:border-blue-600 hover:bg-blue-600 hover:text-white"
            >
              <svg
                className=""
                fill="currentColor"
