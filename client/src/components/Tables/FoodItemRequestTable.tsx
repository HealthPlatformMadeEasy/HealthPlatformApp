...
import {DeleteFoodRequestItemButton, EditFoodRequestItemButton} from "../Buttons";

export function FoodItemRequestRow(props: { item: FoodItem, onClick: () => void, onClick1: () => void }) {
    return <li
        className="flex items-center justify-between space-x-4 bg-gray-100 p-4 rounded-md">
        <div>
            <span className="font-bold text-lg">{props.item.FoodName}</span>
