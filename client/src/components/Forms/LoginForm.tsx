...
import { GenericCancelButton, SubmitLoginButton } from "../Buttons";
...
export function LoginForm() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    GetUserId({ name: username, email: email, password: password }).then(
      (data) => {
        setUserId(data);
      },
    );
  ...
  return (
    <>
      <form
        ...
        className="mb-4 w-full px-8 pb-8 pt-6 shadow-md"
      >
        <div className="m-auto mt-10 w-1/3 bg-white p-10 shadow">
