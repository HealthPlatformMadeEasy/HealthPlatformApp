...
export function LoginForm({setModalOpen}: Props) {
    ...
    if (isSignUp) {
        return <SignUpForm setModalOpen={setModalOpen}/>
    }
    ...
    return (
        <form onSubmit={handleSubmit}
              className="m-auto w-1/3 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div className=" bg-white shadow rounded w-full p-10 m-auto">
                <p className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">Login to your
                    account
                </p>
                <p className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
                    Dont have account?
                    <button onClick={handleSignUpClick}
                            className="ml-1 hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer">
                        Sign up here
                    </button>
                </p>
                <button aria-label="Continue with google" role="button"
                        className="m-auto focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-full border-gray-700 flex items-center justify-center w-3/4 mt-10 transform transition duration-300
                ...
                <button aria-label="Continue with github" role="button"
                        className="m-auto focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-full border-gray-700 flex items-center justify-center w-3/4 mt-4 transform transition duration-300
                        ease-in-out hover:scale-110">
                ...
                <div>
                    ...
                    <input value={username} aria-labelledby="userName" type="userName"
                           ...
                           className="bg-tea_green-100 border rounded-full text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                </div>
                <div>
                ...
                <div className="mt-6  w-full">
                    ...
                    <div className="relative flex items-center justify-center">
                        <input onChange={(e) => setPassword(e.target.value)}
                               value={password} id="pass" type={passwordType}
                               className="bg-tea_green-100 border rounded-full  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                        <div
                            onClick={togglePasswordVisibility} className="absolute right-0 mt-2 mr-3 cursor-pointer">
...
export function LoginForm1() {
    return (
        <form
            className="w-full bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 bg-fixed bg-[url('./assets/pink-fruit-left.png')] bg-cover">
            <div className="w-1/3 bg-white shadow rounded p-10 m-auto">
                <p className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">Login to your
                    account
                </p>
                <p className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
